# Autogenerated wrapper script for polymake_jll for x86_64-linux-gnu-libstdcxx25-cxx11
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (GMP_jll.PATH_list, MPFR_jll.PATH_list, boost_jll.PATH_list, CompilerSupportLibraries_jll.PATH_list, lrslib_jll.PATH_list, PPL_jll.PATH_list, cddlib_jll.PATH_list, FLINT_jll.PATH_list, normaliz_jll.PATH_list, bliss_jll.PATH_list, Perl_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (GMP_jll.LIBPATH_list, MPFR_jll.LIBPATH_list, boost_jll.LIBPATH_list, CompilerSupportLibraries_jll.LIBPATH_list, lrslib_jll.LIBPATH_list, PPL_jll.LIBPATH_list, cddlib_jll.LIBPATH_list, FLINT_jll.LIBPATH_list, normaliz_jll.LIBPATH_list, bliss_jll.LIBPATH_list, Perl_jll.LIBPATH_list,))
